// Country dial codes for the phone field, generated from the world-countries dataset.
// Lebanon first (the default), then alphabetical. Israel is deliberately excluded.
export type CountryCode = { code: string; name: string; dial: string; flag: string };

export const COUNTRY_CODES: CountryCode[] = [
  { code: "LB", name: "Lebanon", dial: "961", flag: "🇱🇧" },
  { code: "AF", name: "Afghanistan", dial: "93", flag: "🇦🇫" },
  { code: "AX", name: "Åland Islands", dial: "35818", flag: "🇦🇽" },
  ...
  { code: "SH", name: "Saint Helena, Ascension and Tristan da Cunha", dial: "2", flag: "🇸🇭" },
  ...
  { code: "SJ", name: "Svalbard and Jan Mayen", dial: "4779", flag: "🇸🇯" },
  ...
  { code: "UM", name: "United States Minor Outlying Islands", dial: "268", flag: "🇺🇲" },
  { code: "VI", name: "United States Virgin Islands", dial: "1340", flag: "🇻🇮" },
  { code: "UY", name: "Uruguay", dial: "598", flag: "🇺🇾" },
  { code: "UZ", name: "Uzbekistan", dial: "998", flag: "🇺🇿" },
  { code: "VU", name: "Vanuatu", dial: "678", flag: "🇻🇺" },
  { code: "VA", name: "Vatican City", dial: "3", flag: "🇻🇦" },
  { code: "VE", name: "Venezuela", dial: "58", flag: "🇻🇪" },
  { code: "VN", name: "Vietnam", dial: "84", flag: "🇻🇳" },
  { code: "WF", name: "Wallis and Futuna", dial: "681", flag: "🇼🇫" },
  { code: "EH", name: "Western Sahara", dial: "2", flag: "🇪🇭" },
